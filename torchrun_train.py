...
from utils.data_loader import FullDataset
from utils.data_loader import FullDataset
...
def training(args):
    ...
    for epoch in tot_epochs:
        ...
        # Set the epoch for the sampler in ddp mode
        if rank != -1:
        ...
        print(
            ...
            .format(epoch, total_step, loss_per_epoch, seq_acc_per_epoch[0], token_acc_per_epoch[0],
        ...
        logging.info(
            ...
            .format(epoch, total_step, loss_per_epoch, sub_loss_record[0], sub_loss_record[1], sub_loss_record[2],
            ...
            with torch.no_grad():
                ...
                if args.return_num >= 10:
                    logging.info(
                        ...
                        .format(epoch, total_step, seq_acc_count[0], seq_acc_count[2], seq_acc_count[4],
                                seq_acc_count[9]))
